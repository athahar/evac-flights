...
export function loadConfig(env) {
  ...
  return {
    ...
    fr24ApiMaxAttempts: parseIntStrict(env.FR24_API_MAX_ATTEMPTS, 4),
    fr24ApiBackoffMs: parseIntStrict(env.FR24_API_BACKOFF_MS, 1200),
    fr24ApiRateLimitPerMinute: parseIntStrict(env.FR24_API_RATE_LIMIT_PER_MINUTE, 8),
    fr24ApiInterRequestDelayMs: parseIntStrict(env.FR24_API_INTER_REQUEST_DELAY_MS, 0),
    fr24ApiMinStatusCoverage: Number.parseFloat(String(env.FR24_API_MIN_STATUS_COVERAGE ?? "0.8")),
    fr24ApiMinFlightCoverage: Number.parseFloat(String(env.FR24_API_MIN_FLIGHT_COVERAGE ?? "0.7")),
    fr24ApiMinDestinationCoverage: Number.parseFloat(String(env.FR24_API_MIN_DESTINATION_COVERAGE ?? "0.95")),
    fr24ApiMinDepartureCoverage: Number.parseFloat(String(env.FR24_API_MIN_DEPARTURE_COVERAGE ?? "0.95")),
